...
import { signInWithEmailAndPassword, onAuthStateChanged, signOut, createUserWithEmailAndPassword, getAuth, GoogleAuthProvider, signInWithPopup } from "firebase/auth";
...
const AdminDashboard = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // onAuthStateChanged will handle setting isAuthenticated
    } catch (err: any) {
      ...
      <div className="min-h-screen pt-20 sm:pt-32 pb-24 px-4 flex flex-col items-center justify-center relative overflow-hidden bg-[#050507]">
        ...
        >
          ...
          <button
            ...
            className="mt-6 w-full py-3.5 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-xl font-bold flex items-center justify-center gap-3 transition-all"
          >
